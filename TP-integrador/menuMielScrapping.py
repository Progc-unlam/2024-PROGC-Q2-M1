...
class MenuScraping:
    ...
    def make_login_menu(self) -> 'pygame_menu.Menu':
        ...
        text_input_user = self.menu.add.text_input('Usuario: ', default='', maxchar=30)
        text_input_pass = self.menu.add.text_input('Contraseña: ', default='', maxchar=30, password=True)
        self.menu.add.button('Iniciar sesión', on_login)
    ...
    def loading_screen(self,screen):
        ...
        image = pygame.transform.scale(imageBackgroundCharge, (window_width, window_height))
        ...
        downLoadThread = threading.Thread(target=self.ms.download_files, daemon=True)
        ...
        while not progress==99:
            ...
            pygame.draw.rect(screen, (0, 255, 0), (progress_rect.x, progress_rect.y, progress * 4, progress_bar_height))
